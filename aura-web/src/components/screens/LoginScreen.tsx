...
const LoginScreen: React.FC = () => {
  ...
  const { login, loginWithGoogle, error, isLoading, user } = useAuth();
      ...
      <div className="w-full max-w-md">
        <div className="card">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2" style={{ color: '#333A44' }}>
              Welcome to Aura
            </h1>
          ...
          <div className="flex items-center my-6">
            <div className="flex-1 border-t" style={{ borderColor: '#D8DEE4' }}></div>
            <span className="px-4 text-sm" style={{ color: '#8A99A8' }}>OR</span>
            <div className="flex-1 border-t" style={{ borderColor: '#D8DEE4' }}></div>
          </div>
